...
var handleException = function (e) { return function (context) { return __awaiter(void 0, void 0, void 0, function () {
    var log, exception;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                log.error(exception);
                return [4 /*yield*/, api_1.compose(api_1.setStatus(exception.status), api_1.sendJson(exception))(context)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
