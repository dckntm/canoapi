    ...
    return function (context) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, api_1.compose(api_1.success, api_1.sendJson(result))(context)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var DispatchQueryFromBody = function (handler) { return exports.DispatchQuery(handler, api_1.DispatchSource.BODY); };
exports.DispatchQueryFromBody = DispatchQueryFromBody;
var DispatchQueryFromQuery = function (handler) { return exports.DispatchQuery(handler, api_1.DispatchSource.QUERY); };
exports.DispatchQueryFromQuery = DispatchQueryFromQuery;
var DispatchQueryFromParams = function (handler) { return exports.DispatchQuery(handler, api_1.DispatchSource.PARAMS); };
