...
var injectMongoConfig = function () {
...
var connectToMongoDatabase = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mongoDatabase;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mongoDatabase = new mongoDatabase_1.MongoDatabase();
                return [4 /*yield*/, mongoDatabase.connect()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
